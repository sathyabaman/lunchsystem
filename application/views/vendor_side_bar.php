      ...
      <div class="sidebar">
        ...
        <div class="sidebar-inner">
          ...
          <ul class="nav nav-sidebar">
            <li>
              <a href="<?php echo base_url(); ?>vendor/dashboard/"><i class="icon-home"></i><span>Dashboard</span></a>
            </li>
            ...
            <li class="nav-parent ">
              ...
              <ul class="children collapse">
                <li>
                  <a href="<?php echo base_url(); ?>vendor/manage_parent/">Manage Parents</a>
                </li>
            ...
            <li class="nav-parent">
              ...
              <ul class="children collapse">
                <li>
                  <a href="<?php echo base_url(); ?>vendor/manage_students/">Manage Students</a>
                </li>
              </ul>
            </li>
            <li class="nav-parent ">
              ...
              <ul class="children collapse">
                <li>
                  <a href="<?php echo base_url(); ?>vendor/manage_vendor/">Manage Vendor</a>
                </li>
            ...
            <li class="nav-parent">
              ...
              <ul class="children collapse">
                <li>
                  <a href="<?php echo base_url(); ?>vendor/manage_menu/">Manage Menu</a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>vendor/add_menu/">Add Menu</a>
                </li>
              </ul>
            </li>
            <li>
              <a href="<?php echo base_url(); ?>vendor/manage_order/"><i class="icon-home"></i><span>Orders</span></a>
            </li>
          ...
          <div class="sidebar-footer clearfix">
            ...
            <a class="pull-left btn-effect" href="<?php echo base_url(); ?>vendor/logout/" data-modal="modal-1" data-rel="tooltip" data-placement="top" data-original-title="Logout">
