...
<html lang="en">
  ...
  <body class="fixed-topbar fixed-sidebar theme-sdtl color-default">
                ...
                <div class="panel">
                  <div class="panel-content widget-info">
                    <div class="row">
                      ...
                      <div class="right">
                        <p class="number countup" data-from="0" data-to="<?php echo $total_order;?>"><?php echo $total_order;?></p>
                ...
                <div class="panel">
                  <div class="panel-content widget-info">
                    <div class="row">
                      ...
                      <div class="right">
                        <p class="number countup" data-from="0" data-to="<?php echo $total_menus;?>" ><?php echo $total_menus;?></p>
                ...
                <div class="panel">
                  <div class="panel-content widget-info">
                    <div class="row">
                      ...
                      <div class="right">
                        <p class="number countup" data-from="0" data-to="<?php echo $total_students;?>" ><?php echo $total_students;?></p>
    ...
    <!-- BEGIN PAGE SCRIPT -->
    <script src="<?php echo base_url(); ?>template/assets/global/plugins/bootstrap-editable/js/bootstrap-editable.min.js"></script> <!-- Inline Edition X-editable -->
    <script src="<?php echo base_url(); ?>template/assets/global/plugins/bootstrap-context-menu/bootstrap-contextmenu.min.js"></script> <!-- Context Menu -->
    <script src="<?php echo base_url(); ?>template/assets/global/plugins/multidatepicker/multidatespicker.min.js"></script> <!-- Multi dates Picker -->
    <script src="<?php echo base_url(); ?>template/assets/global/js/widgets/todo_list.js"></script>
    <script src="<?php echo base_url(); ?>template/assets/global/plugins/metrojs/metrojs.min.js"></script> <!-- Flipping Panel -->
    <script src="<?php echo base_url(); ?>template/assets/global/plugins/charts-chartjs/Chart.min.js"></script>  <!-- ChartJS Chart -->
    <script src="<?php echo base_url(); ?>template/assets/global/plugins/charts-highstock/js/highstock.min.js"></script> <!-- financial Charts -->
    <script src="<?php echo base_url(); ?>template/assets/global/plugins/charts-highstock/js/modules/exporting.min.js"></script> <!-- Financial Charts Export Tool -->
    <script src="<?php echo base_url(); ?>template/assets/global/js/pages/dashboard.js"></script>
    <script src="<?php echo base_url(); ?>template/assets/global/plugins/countup/countUp.min.js"></script> <!-- Animated Counter Number -->
    ...
    <script src="<?php echo base_url(); ?>template/assets/global/js/pages/table_dynamic.js"></script>
    <!-- END PAGE SCRIPT -->
