            ...
            <div class="col-md-12">
              <div class="panel panel-default no-bd">
                <div class="panel-header bg-dark">
                  <h2 class="panel-title"><strong>Add</strong> School Menu Dates</h2>
                </div>
                <div class="panel-body bg-white">
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <form role="form" method="post" action="<?=base_url("school/add_menu_date/");?>" class="form-validation">
                          <div class="row">

                    

                              <h4 class="modal-title" id="myModalLabel">Add Menu Dates</h4><hr>
                              ...
                              <div class="col-lg-3">
                                  <div class="form-group">
                                      ...
                                      <div class="option-group">
                                          <select name="menu" class="category" style="width: 100%; height: 32px;" required>
                              ...
                              <div class="col-lg-3">
                                  <div class="form-group">
                                      ...
                                      <div class="option-group">
                                          ...
                                          <input name="date" type="text" id="datepicker" style="width: 100%; height: 32px;" required>
                                      </div>
                                  </div>
                              </div>
                ...
                <div class="panel-content">
                  ...
                  <table class="table table-hover dataTable" >
                    ...
                    <?php foreach ($display_dates as $menu): ?>
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="<?php echo base_url(); ?>school/delete_menu_dates/<?php echo $menu->available_id; ?>/" onclick="return confirm('Are you sure you want to Remove?');" class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>
