  ...
  <body class="fixed-topbar fixed-sidebar theme-sdtl color-default">
                  ...
                  <table class="table table-hover dataTable">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="items_view" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              ...
                              <div class="row">
                                  <div class="panel-header bg-dark">
                                      <h2 class="panel-title"><strong>Order</strong> Items</h2>
                                  </div>
                                  <table class="table table-hover dataTable" >
                                      <thead>
                                      <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                        	<a href="<?php echo base_url(); ?>administrator/edit_order/<?php echo $order->order_id; ?>" >
                            <button type="button" class="edit btn btn-sm btn-default">
                                <i class="icon-note"></i>
                            </button>
                            </a>

                            <button type="button" data-order-id="<?php echo $order->order_id; ?>" class="edit btn btn-sm btn-default view_all_items"  data-toggle="modal" data-target="#items_view">
                            ...
                            <a href="<?php echo base_url(); ?>administrator/delete_order/<?php echo $order->order_id; ?>" onclick="return confirm('Are you sure you want to Remove?');"  class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>
    ...
    console.log("order id : "+order);
      $.ajax({
              type:"POST",
              dataType: 'json',
              url:"<?php echo base_url('administrator/get_single_order/'); ?>",
              data: {order_id: order},
    ...
    $('.view_all_items').click(function(e){
    e.preventDefault();
    var order = $(this).data('order-id');
    console.log('order_id : '+order);
      ...
      $.ajax({
              type:"POST",
              dataType: 'json',
              url:"<?php echo base_url('administrator/get_all_items_for_single_order/'); ?>",
              data: {order_id: order},
              success: function(data) {
                        //console.log(data);
                        console.log(data.total);
