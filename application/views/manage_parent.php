  ...
  <div class="page-content page-thin">  
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                ...
                <div class="panel-content">
                  <div class="m-b-20">
                    <div class="btn-group">
                    <a href="<?php echo base_url(); ?>administrator/add_parent/">
                      <button id="table-edit_new" class="btn btn-sm btn-dark"><i class="fa fa-plus"></i> Add New Parent</button>
                      </a>
                    </div>
                  </div>
                  ...
                  <table class="table table-hover dataTable" >
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-default no-bd">
                                                        <div class="panel-header bg-dark">
                                                            <h2 class="panel-title"><strong>Edit</strong> a Parent</h2>
                                                        </div>
                                                        <div class="panel-body bg-white">
                                                            <div class="row">
                                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                                    <form role="form" id="frm_add_parent" class="form-validation" method="post" enctype="multipart/form-data" action="<?=base_url("administrator/edit_parent/");?>">
                                                                        <div class="row">
                                                                            <input type="text" id="par_id" name="par_id" style="display: none" >
                                                                            <div class="col-sm-6">
                                                                         ...
                                                                         <div class="row">
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="append-icon">
                                                                                        <input type="password" id="par_password" name="par_password" id="password" class="form-control" placeholder="Between 4 and 16 characters" minlength="4" maxlength="16" >
                                                                                        <i class="icon-lock"></i>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="append-icon">
                                                                                        <input type="password" id="par_password2" name="par_password2" id="password2" class="form-control" placeholder="Must be equal to your first password..." minlength="4" maxlength="16" >
                                                                                        <i class="icon-lock"></i>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="panel-header bg-dark">
                                                                                <h2 class="panel-title"><strong>Edit</strong> Student</h2>
                                                                            </div>
                                                                            <table class="table table-hover dataTable" >
                                                                                <thead>
                                                                                <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a href="<?php echo base_url(); ?>administrator/delete_parent/<?php echo $par->par_id; ?>" onclick="return confirm('Are you sure you want to Remove?');" class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>
                            <!-- Modal -->
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
    ...
    console.log(parent);
      ...
      $.ajax({
              type:"POST",
              dataType: 'json',
              url:"<?php echo base_url('administrator/get_student_single_parent/'); ?>",
              data: {parent_id: parent},
              success: function(data) {
                        //console.log(data);
                        console.log(data.total);
                        ...
                        for (var i = 0; i < data.total.length; i++) {
                                  ...
                                  $('<tr>'+
                                      ...
                                      '<td>'+data.total[i].classroom_name+'</td>'+
                                    
                                      '<td class="text-right">'+
                                          '<a href="mngstudent.html">'+
                                          '<button type="button" class="edit btn btn-sm btn-default"  data-toggle="modal">'+

                                              '<i class="icon-note"></i>'+
                                          '</button>'+
                                          '</a>'+
                                          '<a href="<?php echo base_url(); ?>administrator/delete_student_parent/'+data.total[i].stu_id+'" onclick="return confirm("Are you sure you want to Remove?");" class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>'+
