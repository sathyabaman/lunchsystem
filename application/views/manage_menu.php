  ...
  <body class="fixed-topbar fixed-sidebar theme-sdtl color-default">
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                ...
                <div class="panel-content">
                  <div class="m-b-20">
                    <div class="btn-group">
                    <a href="<?php echo base_url(); ?>administrator/add_menu/">
                  ...
                  <table class="table table-hover dataTable" >
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              ...
                              <div class="row">
                                  <div class="panel-header bg-dark">
                                      <h2 class="panel-title"><strong>Menu</strong> Items</h2>
                                  </div>
                                  <table class="table table-hover dataTable" >
                                      <thead>
                                      <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right"> 
                             ...
                             <a href="<?php echo base_url(); ?>administrator/edit_menu/<?php echo $menu->menu_id; ?>" class="btn btn-sm btn-default" ><i class="icon-note" ></i></a>
                            ...
                            <a href="<?php echo base_url(); ?>administrator/delete_menu/<?php echo $menu->menu_id; ?>" onclick="return confirm('Are you sure you want to Remove?');" class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>
                            <!-- Modal -->
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
    ...
    console.log('menu_id : '+menu);
      ...
      $.ajax({
              type:"POST",
              dataType: 'json',
              url:"<?php echo base_url('administrator/get_items_single_menu/'); ?>",
              data: {menu_id: menu},
