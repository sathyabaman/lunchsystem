  ...
  <body class="fixed-topbar fixed-sidebar theme-sdtl color-default">
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                ...
                <div class="panel-content">
                  <div class="m-b-20">
                    <div class="btn-group">
                    <a href="<?php echo base_url(); ?>administrator/add_school/">
                      <button class="btn btn-sm btn-dark" ><i class="fa fa-plus"></i> Add New School</button>
                      </a>
                    </div>
                  </div>
                  <table class="table table-hover dataTable" >
                                            ...
                                            <div class="panel-body bg-white">
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <form role="frm_edit_school" class="form-validation" method="post" enctype="multipart/form-data" action="<?=base_url("administrator/edit_school/");?>">
                                                            <div class="row">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a href="<?php echo base_url(); ?>administrator/delete_school/<?php echo $school->sch_id; ?>" onclick="return confirm('Are you sure you want to Remove?');" class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>
                            <!-- Modal -->
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
    ...
    console.log(school);
      $.ajax({
              type:"POST",
              dataType: 'json',
              url:"<?php echo base_url('administrator/get_single_school/'); ?>",
