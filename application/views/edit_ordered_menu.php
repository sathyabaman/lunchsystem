                ...
                <div class="panel-body bg-white">
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <form role="form" method="post" action="<?=base_url("administrator/edit_order_paid_delivary/");?>" class="form-validation">
                          <div class="row">
                  ...
                  <table class="table table-hover dataTable" >
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a href="<?php echo base_url(); ?>administrator/delete_order_item/<?php echo $menu->order_item_id; ?>" onclick="return confirm('Are you sure you want to Remove?');" class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>
                            <!-- Modal -->
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
