  ...
  <body class="fixed-topbar fixed-sidebar theme-sdtl color-default">
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                ...
                <div class="panel-content">
                  <div class="m-b-20">
                    <div class="btn-group">
                    <a href="<?php echo base_url(); ?>vendor/add_menu/">
                  ...
                  <table class="table table-hover dataTable" >
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a href="<?php echo base_url(); ?>vendor/delete_menu/<?php echo $menu->menu_id; ?>" onclick="return confirm('Are you sure you want to Remove?');" class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>
                            <!-- Modal -->
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
    ...
    console.log('menu_id : '+menu);
      ...
      $.ajax({
              type:"POST",
              dataType: 'json',
              url:"<?php echo base_url('vendor/get_items_single_menu/'); ?>",
              data: {menu_id: menu},
                        ...
                        for (var i = 0; i < data.total.length; i++) {
                                  ...
                                  $('<tr>'+
                                      ...
                                      '<td class="text-right">'+
                                          ...
                                          '</button>'+
                                          '</a>'+
                                          '<a href="<?php echo base_url(); ?>administrator/delete_item/'+data.total[i].item_id+'" onclick="return confirm("Are you sure you want to Remove?");" class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>'+
