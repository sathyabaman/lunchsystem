            ...
            <div class="col-md-12">
              <div class="panel panel-default no-bd">
                <div class="panel-header bg-dark">
                  <h2 class="panel-title"><strong>Create</strong> a Menu</h2>
                </div>
                <div class="panel-body bg-white">
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <form role="form" method="post" action="<?=base_url("administrator/add_menu/");?>" class="form-validation">
                          <div class="row">
                              ...
                              <div class="col-lg-12">
                                  <div class="form-group">
                                      ...
                                      <div class="append-icon">
                                          <input type="text" name="menuname" class="form-control" minlength="3" placeholder="Minimum 3 characters..." required>
                                          <i class="icon-user"></i>
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="menu_old">
                              <div class="col-lg-3">
                                  <div class="form-group">
                                      ...
                                      <div class="append-icon">
                                          <input type="text" name="item_name1" class="form-control item_name" minlength="3" placeholder="Minimum 3 characters..." required>
                                          <i class="icon-user"></i>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-3">
                                  <div class="form-group">
                                      ...
                                      <div class="option-group">
                                          <select name="category1" class="category" style="width: 100%; height: 32px;" required>
                              ...
                              <div class="col-lg-3">
                                  <div class="form-group">
                                      ...
                                      <div class="append-icon">
                                          <input type="text"  name="price1" class="form-control price" minlength="1" placeholder="Minimum 1 characters..." required>
                                          <i class="icon-user"></i>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-3">
                                  <div class="form-group">
                                      ...
                                      <div class="append-icon">
                                          <input type="text"  name="cost1" class="form-control cost" minlength="1" placeholder="Minimum 1 characters..." required>
                                          <i class="icon-user"></i>
                                      </div>
                                  </div>
                              </div>
                      ...
                      <div class="menu_new">  </div>
                              ...
                              <div class="text-center  m-t-20">
                                  <button type="submit" name="submit" class="btn btn-embossed btn-primary">Create Menu</button>
