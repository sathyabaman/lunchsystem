            ...
            <div class="col-md-12">
              <div class="panel panel-default no-bd">
                <div class="panel-header bg-dark">
                  <h2 class="panel-title"><strong>Edit</strong> a Menu</h2>
                </div>
                <div class="panel-body bg-white">
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <form role="form" method="post" action="<?=base_url("administrator/add_menu_items_edit/");?>" class="form-validation">
                          <div class="row">
                              ...
                              <div class="col-lg-12">
                                  <div class="form-group">
                                      ...
                                      <div class="append-icon">
                                          <input type="text" name="menuname" value="<?php echo $menu[0]->menu_name; ?>" class="form-control" minlength="3" placeholder="Minimum 3 characters..." required>
                                          <input type="text" name="menuid" value="<?php echo $menu[0]->menu_id; ?>" style="display: none;" >
                                          <i class="icon-user"></i>
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="menu_old">
                              <div class="col-lg-3">
                                  <div class="form-group">
                                      ...
                                      <div class="append-icon">
                                          <input type="text" name="item_name1" class="form-control item_name" >
                                          <i class="icon-user"></i>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-3">
                                  <div class="form-group">
                                      ...
                                      <div class="option-group">
                                          <select name="category1" class="category" style="width: 100%; height: 32px;" >
                              ...
                              <div class="col-lg-3">
                                  <div class="form-group">
                                      ...
                                      <div class="append-icon">
                                          <input type="text"  name="price1" class="form-control price"  >
                                          <i class="icon-user"></i>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-3">
                                  <div class="form-group">
                                      ...
                                      <div class="append-icon">
                                          <input type="text"  name="cost1" class="form-control cost" >
                                          <i class="icon-user"></i>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="col-lg-3"style="float: right;" >
                                  <div class="form-group">
                                      ...
                                      <div class="append-icon">
                                          <textarea name="description1" class="form-control description" required ></textarea>  
                                          <i class="icon-user"></i>
                                      </div>
                                  </div>
                              </div>
                      ...
                      <div class="menu_new">  </div>
                              ...
                              <div class="add_items"><a><i class="fa fa-plus"></i><u>Add More Items</u></a></div>
                            
                              <div class="text-center  m-t-20">
                                  <button type="submit" name="submit" class="btn btn-embossed btn-primary">Add New Items</button>
                      ...
                      <div class="row">
                                ...
                                <tr>
                                      ...
                                      <td class="text-right">
                                          ...
                                          <a href="<?php echo base_url(); ?>administrator/delete_edit_item/<?php echo $item->menu_id; ?>/<?php echo $item->item_id; ?>" onclick="return confirm("Are you sure you want to Remove?");" class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>
    ...
    <script src="<?php echo base_url(); ?>template/assets/admin/layout1/js/layout.js"></script>
     ...
     <script type="text/javascript">
            ...
            $('.add_items').click (function(){
                ...
                var clonedEl = $('.menu_old').first().clone();
                
                clonedEl.find('.item_name').attr('name','item_name'+count);
                clonedEl.find('.category').attr('name','category'+count);
                clonedEl.find('.price').attr('name','price'+count);
                clonedEl.find('.cost').attr('name','cost'+count);
                clonedEl.find('.description').attr('name','description'+count);

                //clonedEl.find("<select>").attr('name','std_scl_name'+count);
                //Add the newly div the the entire div
                $('.menu_new').append(clonedEl);
                count++;
              });
          });
        </script>
