                ...
                <div class="panel-body bg-white">
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <form role="form" method="post" action="<?=base_url("school/add_menu_items_edit/");?>" class="form-validation">
                          <div class="row">
                      ...
                      <div class="row">
                                ...
                                <tr>
                                      ...
                                      <td class="text-right">
                                          ...
                                          <a href="<?php echo base_url(); ?>school/delete_edit_item/<?php echo $item->menu_id; ?>/<?php echo $item->item_id; ?>" onclick="return confirm("Are you sure you want to Remove?");" class="delete btn btn-sm btn-danger" ><i class="icons-office-52"></i></a>
